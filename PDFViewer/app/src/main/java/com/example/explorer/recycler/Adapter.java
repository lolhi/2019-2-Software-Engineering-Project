    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (itemLayout) {
            ...
            case R.layout.list_item_0:
                return new com.example.explorer.recycler.ViewHolder0(context, onItemClickListener, itemView);

            case R.layout.list_item_1:
                return new com.example.explorer.recycler.ViewHolderAudio(context, onItemClickListener, itemView);

            case R.layout.list_item_2:
                return new com.example.explorer.recycler.ViewHolderImage(context, onItemClickListener, itemView);

            case R.layout.list_item_3:
                return new com.example.explorer.recycler.ViewHolderVideo(context, onItemClickListener, itemView);
